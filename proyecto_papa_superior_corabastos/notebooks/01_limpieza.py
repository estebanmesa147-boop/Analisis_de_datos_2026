...
# =============================================================
# PASO 2: Limpiar abastecimiento
# =============================================================
df_abast = df_abast_raw.copy()

# Corregir columna con encoding roto (AÃ±o → Año)
df_abast.columns = [
...
# =============================================================
# PASO 5: Agregar a nivel mensual
# =============================================================

# Abastecimiento mensual — suma de toneladas por mes
abast_mensual = df_abast_filtrado.groupby(
    ['Año', 'mes'], as_index=False
)['Toneladas'].sum()

# Precios mensual — promedio por mes
...
# =============================================================
# PASO 7: Guardar archivos procesados
# =============================================================
df_maestro.to_csv(
